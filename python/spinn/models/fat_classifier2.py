...
def sequential_only():
    return FLAGS.model_type == "RNN" or FLAGS.model_type == "CBOW" or FLAGS.model_type == "SOFTSPINN"
...
def run(only_forward=False):
    ...
    elif FLAGS.model_type == "SOFTSPINN":
        model_module = spinn.soft_stack
    else:
    ...
    print("file", os.path.isfile(best_checkpoint_path))
    best_checkpoint_path = "/Users/kellyzhang/Documents/spinn/logs/listops-SOFTSPINN-1490213080.ckpt_best"
    ...
    if only_forward:
        ...
        model(X_batch, transitions_batch, y_batch,
                use_internal_parser=FLAGS.use_internal_parser,
                validate_transitions=FLAGS.validate_transitions,
                num_transitions_batch=num_transitions_batch
                )
...
if __name__ == '__main__':
    ...
    gflags.DEFINE_string("ckpt_path", "/Users/kellyzhang/Documents/spinn/logs/listops-SOFTSPINN-1490213080.ckpt_best", "Where to save/load checkpoints. Can be either "
    ...
    gflags.DEFINE_enum("model_type", "RNN", ["CBOW", "RNN", "SPINN", "RLSPINN", "RAESPINN", "GENSPINN", "SOFTSPINN"], "")

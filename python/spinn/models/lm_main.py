...
parser.add_argument('--tdnn', action='store_true',
                    help='uses window attention')
...
if args.load != "":
    ...
    if args.attn:
        ...
        """
        Add correct model parameters
        """
        model = model.TDNNModel(args.model, nchartokens, char_embed_dim, ntokens, args.emsize, args.nhid, args.nlayers, args.dropout, args.tied)
    else:
